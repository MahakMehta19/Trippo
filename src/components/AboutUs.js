...
function AboutUs() {
  return (
    <div className="about-container">
      <h1>Our History</h1>
      <p>
        Trippo is owned and managed by Trippo.in Pvt. Ltd. a leading in web
        designing services and e-commerce solutions. Trippo.In Pvt Ltd. is
        counted for its expertise in webb solutions and its top ranking business
        ...
        rate of other portals managed by Trippo. It ia a live paradigm of our
        work excellence.
      </p>
      <h1>Our Mission</h1>
      <p>
